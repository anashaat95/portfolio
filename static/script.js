                            ...
                            if (this.affixed != a) {
                                ...
                                (this.affixed = a),
                                    ...
                                    this.$element
                                        ...
                                        .addClass(l)
                                        .trigger(
                                            l.replace("affix", "affixed") +
                                                ".bs.affix"
                                        );
                            }
                            "bottom" == a &&
                                this.$element.offset({ top: s - e - r });
                        }
                    });
                var i = t.fn.affix;
                (t.fn.affix = e),
                ...
                (e.VERSION = "3.3.7"),
                    ...
                    (e.prototype.process = function () {
                        ...
                        if ((this.scrollHeight != n && this.refresh(), e >= i))
                            return (
                                s != (t = r[r.length - 1]) && this.activate(t)
                            );
                        if (s && e < o[0])
                    ...
                    if ((i = G.prefilters[r].call(u, t, c, u.opts)))
                        return (
                            yt.isFunction(i.stop) &&
                                (yt._queueHooks(u.elem, u.opts.queue).stop =
                                    yt.proxy(i.stop, i)),
                            i
                        );
                return (
                    ...
                    yt.fx.timer(
                        yt.extend(l, { elem: t, anim: u, queue: u.opts.queue })
                    ),
                    u
                );
            }
                    ...
                    if (
                        ...
                        if (11 !== h && (l = gt.exec(t)))
                            if ((o = l[1])) {
                                ...
                                if (l[2])
                                    return (
                                        G.apply(n, e.getElementsByTagName(t)), n
                                    );
                                if (
                                    (o = l[3]) &&
                                    ...
                                    return (
                                        G.apply(n, e.getElementsByClassName(o)),
                                        n
                                    );
                            }
                    ...
                    if (a || "jsonp" === t.dataTypes[0])
                        return (
                            ...
                            (t.converters["script json"] = function () {
                                return (
                                    s || yt.error(o + " was not called"), s[0]
                                );
                            }),
                            (t.dataTypes[0] = "json"),
                            (r = n[o]),
                            ...
                            return r.getClientRects().length
                                ? ((i = r.getBoundingClientRect()),
                                  ...
                                  (o = e.defaultView),
                                  {
                                      ...
                                      left:
                                          i.left + o.pageXOffset - n.clientLeft,
                                  })
                                : { top: 0, left: 0 };
                    },
                    position: function () {
